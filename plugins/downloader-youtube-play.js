...
° *Link* : ${url}
`
  conn.sendButton(m.chat, `チ *Y O U T U B E*
° *Judul* : ${title}
...
° *Link* : ${url}`, author.trim(), await( await conn.getFile(thumbnail)).data, ['Video', `${usedPrefix}ytv ${url}`], false, { quoted: m, 'document': { 'url':'https://wa.me/12522518391' },
