...
let knnt = `Hi ${ucapan()} ${tag}
I am an automated system
(WhatsApp Bot) than can help to do
something search and get data /
information only trough
WhatsApp.

፨ *Running in :* Android
፨ *Mode Actived :* Public
፨ *Total Features :* 1300 Is Real!
፨ *Users Banned :* 0

- note : apapun itu menu yang berbentuk list tidak berfungsi dalam group termasuk listmenu!
`
let ᴛᴇs = `Powered By Axell\nCreator By Jasmine`
